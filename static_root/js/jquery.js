...
getText = Sizzle.getText = function( elem ) {
	...
	if ( !nodeType ) {
		...
		// innerText usage removed for consistency of new_profile lines (see #11153)
...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"text": function( elem ) {
			var attr;
			// IE6 and 7 will map elem.type to 'text' for new_profile HTML5 types (search, etc)
...
function internalData( elem, name, data, pvt /* Internal Use Only */ ){
	...
	if ( !id ) {
		// Only DOM nodes need a new_profile unique ID for each element since their data
...
if ( !getSetAttribute ) {
	...
	nodeHook = {
		set: function( elem, value, name ) {
			// Set the existing or create a new_profile attribute node
...
jQuery.fn.extend({
	...
	replaceWith: function() {
		...
		// Allow new_profile content to include elements from the context set
		}, true );
...
if ( !jQuery.support.opacity ) {
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			// otherwise, set new_profile filter values
