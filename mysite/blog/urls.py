...
urlpatterns = [
    ...
    # url(r'^(?P<item_slug>.*)/(?P<category_slug>.*)/', include([
    #     url(r'^list/$', 'blog.views.article_list', name='article_list'),
    #     url(r'^create/$', 'blog.views.article_create', name='article_create'),
    #     url(r'^(?P<article_slug>.*)/edit/$', 'blog.views.article_update',
    #         name='article_update'),
    #     url(r'^(?P<article_slug>.*)/delete/$', 'blog.views.article_delete',
    #         name='article_delete'),
    #     url(r'^(?P<article_slug>.*)/$', 'blog.views.article_detail',
    #         name='article_detail'),
    #     ])),
